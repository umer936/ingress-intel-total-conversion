...
window.showPortalPosLinks = function(lat, lng, name) {
  ...
  if (typeof android !== 'undefined' && android && android.intentPosLink) {
    ...
    var wazemaps = '<a href="#" onclick="window.open(\'https://www.waze.com/livemap?zoom=17&lat='+lat+'&lon='+lng+'\');window.open(\'http://waze.to/?q='+lat+','+lng+'&navigate=yes\');">Waze Maps</a>';
    ...
    dialog({
      html: '<div style="text-align: center;">' + qrcode + script + gmaps + '; ' + bingmaps + '; ' + wazemaps + '; ' + osm + '<br />' + latLng + '</div>',
      title: name,
      id: 'poslinks'
    });
  }
